...
function dataCenterUrl() {
  const base = resolveApiBase();
  return (base ? base : "") + "/ecommerce-api/data-center?v=20260831-r15";
}
async function fetchAllProducts() {
  const page = await call("/ecommerce-api/products/all");
  return page.items;
}
async function createProduct(input) {
  return post("/ecommerce-api/product/create", input);
}
async function updateProduct(sku, patch) {
  return post("/ecommerce-api/product/update", { sku, ...patch });
}
async function deleteProduct(sku) {
  return post("/ecommerce-api/product/delete", { sku });
}
async function adjustStock(sku, delta) {
  return post("/ecommerce-api/product/stock", { sku, delta });
}
async function setProductStatus(sku, status) {
  return post("/ecommerce-api/product/status", { sku, status });
}
...
function analysisPromptOf(product) {
...
function BiKpiGrid(props) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "esd-bi-kpi-grid" }, kpis.map((k) => /* @__PURE__ */ React.createElement("div", { className: "esd-bi-kpi-card", key: k.label }, /* @__PURE__ */ React.createElement("div", { className: "esd-bi-kpi-title" }, k.label), /* @__PURE__ */ React.createElement("div", { className: "esd-bi-kpi-value" }, k.value), /* @__PURE__ */ React.createElement("div", { className: "esd-bi-kpi-sub " + k.subTone }, k.sub))));
}
function BiTrendChart(props) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "esd-bi-chart" }, /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${W} ${H}`, preserveAspectRatio: "none", className: "esd-bi-svg" }, /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement("linearGradient", { id: "esd-bi-area", x1: "0", y1: "0", x2: "0", y2: "1" }, /* @__PURE__ */ React.createElement("stop", { offset: "0%", stopColor: "#2bb8a3", stopOpacity: "0.22" }), /* @__PURE__ */ React.createElement("stop", { offset: "100%", stopColor: "#2bb8a3", stopOpacity: "0" }))), /* @__PURE__ */ React.createElement("path", { d: area, fill: "url(#esd-bi-area)" }), /* @__PURE__ */ React.createElement("path", { d: line, fill: "none", stroke: "#2bb8a3", strokeWidth: "2", strokeLinejoin: "round", strokeLinecap: "round" }), pts.map((p, i) => /* @__PURE__ */ React.createElement("circle", { key: p.date, cx: xs(i), cy: ys(p.revenue), r: i === pts.length - 1 ? 3.5 : 2, fill: "#2bb8a3" }))), /* @__PURE__ */ React.createElement("div", { className: "esd-bi-chart-labels" }, /* @__PURE__ */ React.createElement("span", null, pts[0]?.date?.slice(5)), /* @__PURE__ */ React.createElement("span", null, pts[Math.floor(pts.length / 2)]?.date?.slice(5)), /* @__PURE__ */ React.createElement("span", null, pts[pts.length - 1]?.date?.slice(5))));
}
var CAT_COLORS = ["#2bb8a3", "#3fcdb6", "#1f9e8a", "#6fdcc8", "#159c84", "#9be8da", "#0e8a76", "#5fcdb4"];
function BarRow(props) {
  const { item, max, ratio } = props;
  return /* @__PURE__ */ React.createElement("div", { className: "esd-bi-bar-row", key: item.key }, /* @__PURE__ */ React.createElement("span", { className: "esd-bi-bar-name", title: item.name }, item.name), /* @__PURE__ */ React.createElement("div", { className: "esd-bi-bar-track" }, /* @__PURE__ */ React.createElement(
    "div",
    {
...
function BiCategoryBars(props) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "esd-bi-bar" }, items.map((it) => /* @__PURE__ */ React.createElement(BarRow, { key: it.key, item: it, max: 100, ratio: it.value })), cats.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "esd-bi-empty" }, "\u6682\u65E0\u7C7B\u76EE\u6570\u636E") : null);
}
function BiTopBar(props) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "esd-bi-bar" }, rows.map((it) => /* @__PURE__ */ React.createElement(BarRow, { key: it.key, item: it, max, ratio: it.value / max * 100 })), items.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "esd-bi-empty" }, "\u6682\u65E0\u9500\u552E\u6570\u636E") : null);
}
function BiDashboardSection(props) {
  const s = props.snapshot;
  return /* @__PURE__ */ React.createElement("div", { className: "esd-bi" }, /* @__PURE__ */ React.createElement(BiKpiGrid, { snapshot: s }), /* @__PURE__ */ React.createElement("div", { className: "esd-bi-grid" }, /* @__PURE__ */ React.createElement("div", { className: "esd-bi-card" }, /* @__PURE__ */ React.createElement("div", { className: "esd-bi-card-title" }, "\u8FD1 30 \u5929\u9500\u552E\u8D8B\u52BF"), /* @__PURE__ */ React.createElement(BiTrendChart, { points: s.trend30 })), /* @__PURE__ */ React.createElement("div", { className: "esd-bi-card" }, /* @__PURE__ */ React.createElement("div", { className: "esd-bi-card-title" }, "\u5E93\u5B58\u5065\u5EB7\u5EA6"), /* @__PURE__ */ React.createElement("div", { className: "esd-bi-stock" }, /* @__PURE__ */ React.createElement("div", { className: "esd-bi-stock-line" }, /* @__PURE__ */ React.createElement("span", null, "\u4F4E\u5E93\u5B58\u5546\u54C1\uFF08\u2264\u9608\u503C\uFF09"), /* @__PURE__ */ React.createElement("em", null, s.lowStock.length, " \u4EF6")), s.lowStock.slice(0, 6).map((p) => /* @__PURE__ */ React.createElement("div", { className: "esd-bi-stock-row", key: p.sku }, /* @__PURE__ */ React.createElement("span", { title: p.name }, p.name), /* @__PURE__ */ React.createElement("span", { className: "esd-bi-stock-num" }, p.stock, " \u4EF6"))), s.lowStock.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "esd-bi-empty" }, "\u5E93\u5B58\u5065\u5EB7\uFF0C\u65E0\u4F4E\u5E93\u5B58\u5546\u54C1") : null))), /* @__PURE__ */ React.createElement("div", { className: "esd-bi-grid" }, /* @__PURE__ */ React.createElement("div", { className: "esd-bi-card" }, /* @__PURE__ */ React.createElement("div", { className: "esd-bi-card-title" }, "\u7C7B\u76EE\u9500\u552E\u5360\u6BD4"), /* @__PURE__ */ React.createElement(BiCategoryBars, { categories: s.categories })), /* @__PURE__ */ React.createElement("div", { className: "esd-bi-card" }, /* @__PURE__ */ React.createElement("div", { className: "esd-bi-card-title" }, "TOP 5 \u5546\u54C1\u9500\u552E\u989D\u6392\u884C"), /* @__PURE__ */ React.createElement(BiTopBar, { top: s.top }))));
}
function ProductForm(props) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "esd-bi-modal-mask", onClick: props.onClose }, /* @__PURE__ */ React.createElement("div", { className: "esd-bi-modal", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { className: "esd-bi-modal-title" }, props.initial.sku === null ? "\u65B0\u589E\u5546\u54C1" : `\u7F16\u8F91\u5546\u54C1 ${props.initial.sku}`), /* @__PURE__ */ React.createElement("label", { className: "esd-bi-field" }, /* @__PURE__ */ React.createElement("span", null, "\u5546\u54C1\u540D\u79F0"), /* @__PURE__ */ React.createElement("input", { value: name, onChange: (e) => setName(e.target.value), placeholder: "\u4F8B\u5982\uFF1A\u4FBF\u643A\u5145\u7535\u5B9D", autoFocus: true })), /* @__PURE__ */ React.createElement("label", { className: "esd-bi-field" }, /* @__PURE__ */ React.createElement("span", null, "\u5206\u7C7B"), /* @__PURE__ */ React.createElement("input", { value: category, onChange: (e) => setCategory(e.target.value), placeholder: "\u4F8B\u5982\uFF1A\u6570\u7801\u914D\u4EF6" })), /* @__PURE__ */ React.createElement("div", { className: "esd-bi-field-row" }, /* @__PURE__ */ React.createElement("label", { className: "esd-bi-field" }, /* @__PURE__ */ React.createElement("span", null, "\u552E\u4EF7\uFF08\u5143\uFF09"), /* @__PURE__ */ React.createElement("input", { type: "number", value: price, onChange: (e) => setPrice(e.target.value), placeholder: "0.00", min: "0" })), /* @__PURE__ */ React.createElement("label", { className: "esd-bi-field" }, /* @__PURE__ */ React.createElement("span", null, "\u5E93\u5B58"), /* @__PURE__ */ React.createElement("input", { type: "number", value: stock, onChange: (e) => setStock(e.target.value), placeholder: "0", min: "0" }))), err !== null ? /* @__PURE__ */ React.createElement("div", { className: "esd-bi-form-err" }, err) : null, /* @__PURE__ */ React.createElement("div", { className: "esd-bi-modal-actions" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "esd-bi-btn", onClick: props.onClose, disabled: busy }, "\u53D6\u6D88"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "esd-bi-btn esd-bi-btn-primary", onClick: () => void submit(), disabled: busy }, busy ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58"))));
}
function ProductManagerSection(props) {
  const [form, setForm] = React.useState(null);
  const [keyword, setKeyword] = React.useState("");
  const items = props.products ?? [];
  const filtered = keyword.trim() === "" ? items : items.filter((p) => p.name.includes(keyword) || p.sku.toLowerCase().includes(keyword.toLowerCase()) || p.category.includes(keyword));
  return /* @__PURE__ */ React.createElement("div", { className: "esd-pm" }, /* @__PURE__ */ React.createElement("div", { className: "esd-pm-toolbar" }, /* @__PURE__ */ React.createElement(
    "input",
    {
  ...
  ), /* @__PURE__ */ React.createElement("button", { type: "button", className: "esd-bi-btn", onClick: props.onRefresh, disabled: props.loading }, props.loading ? "\u52A0\u8F7D\u4E2D\u2026" : "\u5237\u65B0"), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    "+ \u65B0\u589E\u5546\u54C1"
  ), /* @__PURE__ */ React.createElement("button", { type: "button", className: "esd-bi-btn", onClick: () => props.onExport("all") }, "\u2B07 \u5BFC\u51FA")), props.products === null && props.loading ? /* @__PURE__ */ React.createElement("div", { className: "esd-bi-empty" }, "\u6B63\u5728\u52A0\u8F7D\u5546\u54C1\u2026") : filtered.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "esd-bi-empty" }, "\u6CA1\u6709\u7B26\u5408\u6761\u4EF6\u7684\u5546\u54C1") : /* @__PURE__ */ React.createElement("div", { className: "esd-pm-table-wrap" }, /* @__PURE__ */ React.createElement("table", { className: "esd-pm-table" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "SKU"), /* @__PURE__ */ React.createElement("th", null, "\u5546\u54C1\u540D\u79F0"), /* @__PURE__ */ React.createElement("th", null, "\u5206\u7C7B"), /* @__PURE__ */ React.createElement("th", { className: "esd-pm-num" }, "\u552E\u4EF7"), /* @__PURE__ */ React.createElement("th", { className: "esd-pm-num" }, "\u5E93\u5B58"), /* @__PURE__ */ React.createElement("th", null, "\u72B6\u6001"), /* @__PURE__ */ React.createElement("th", { className: "esd-pm-ops" }, "\u64CD\u4F5C"))), /* @__PURE__ */ React.createElement("tbody", null, filtered.map((p) => /* @__PURE__ */ React.createElement("tr", { key: p.sku, className: p.status === "off_sale" ? "esd-pm-off" : "" }, /* @__PURE__ */ React.createElement("td", { className: "esd-pm-sku" }, p.sku), /* @__PURE__ */ React.createElement("td", { className: "esd-pm-name", title: `\u70B9\u51FB\u5206\u6790\u300C${p.name}\u300D`, onClick: () => props.onAnalyze(p) }, p.name), /* @__PURE__ */ React.createElement("td", null, p.category), /* @__PURE__ */ React.createElement("td", { className: "esd-pm-num" }, formatMoney(p.price)), /* @__PURE__ */ React.createElement("td", { className: "esd-pm-num" + (p.stock === 0 ? " esd-pm-zero" : "") }, p.stock), /* @__PURE__ */ React.createElement("td", null, p.status === "on_sale" ? "\u5728\u552E" : "\u4E0B\u67B6"), /* @__PURE__ */ React.createElement("td", { className: "esd-pm-ops" }, /* @__PURE__ */ React.createElement("button", { type: "button", title: "\u5206\u6790\u8BE5\u5546\u54C1", onClick: () => props.onAnalyze(p) }, "\u{1F50D}"), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      title: "\u7F16\u8F91",
    ...
    "\u270F\uFE0F"
  ), /* @__PURE__ */ React.createElement("button", { type: "button", title: "\u5165\u5E93 +10", onClick: () => void props.onStock(p.sku, 10) }, "\u2795"), /* @__PURE__ */ React.createElement("button", { type: "button", title: "\u51FA\u5E93 -10", onClick: () => void props.onStock(p.sku, -10) }, "\u2796"), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    "\u{1F5D1}\uFE0F"
  ))))))), form !== null ? /* @__PURE__ */ React.createElement(
    ProductForm,
    {
      initial: form,
...
function useShopDeskData() {
  ...
  const [products, setProducts] = React3.useState(null);
  const [productsLoading, setProductsLoading] = React3.useState(false);
  ...
  const productsLoadedRef = React3.useRef(false);
  const loadProducts = React3.useCallback(async (force2 = false) => {
    if (!force2 && productsLoadedRef.current) return;
  ...
  const refreshAfterChange = React3.useCallback(async () => {
    await Promise.all([load(true), loadProducts(true)]);
  }, [load, loadProducts]);
  const onProductCreate = React3.useCallback(
    async (input) => {
  ...
  const onProductUpdate = React3.useCallback(
    async (sku, patch) => {
  ...
  const onProductDelete = React3.useCallback(
    async (sku) => {
  ...
  const onProductStock = React3.useCallback(
    async (sku, delta) => {
  ...
  const onProductStatus = React3.useCallback(
    async (sku, status) => {
  ...
  const analyzeProduct = React3.useCallback((product) => {
...
function ShopDeskTab() {
  ...
  ), /* @__PURE__ */ React3.createElement(TodoSection, { snapshot: d.snapshot, expanded: d.expanded, onToggle: d.toggleExpand }), /* @__PURE__ */ React3.createElement(
    CategorySection,
    {
      snapshot: d.snapshot,
  ...
  ), /* @__PURE__ */ React3.createElement(TopSection, { snapshot: d.snapshot }), /* @__PURE__ */ React3.createElement(
  ...
  ), /* @__PURE__ */ React3.createElement(LowStockSection, { snapshot: d.snapshot, expanded: d.expanded.lowStock, onToggle: () => d.toggleExpand("lowStock") }), /* @__PURE__ */ React3.createElement(
    BriefSection,
    {
      brief: d.brief,
...
function ShopDeskPanel() {
  ...
  return /* @__PURE__ */ React3.createElement("div", { className: "esd-root" }, /* @__PURE__ */ React3.createElement(Boundary, null, d.open ? /* @__PURE__ */ React3.createElement("aside", { className: "esd-panel" + (d.fullscreen ? " esd-panel-fullscreen" : ""), role: "complementary", "aria-label": "\u6570\u636E\u67E5\u770B" }, /* @__PURE__ */ React3.createElement("header", { className: "esd-header" }, /* @__PURE__ */ React3.createElement("span", { className: "esd-header-logo" }, /* @__PURE__ */ React3.createElement(BrandBadge, { size: 24 })), /* @__PURE__ */ React3.createElement("h3", { className: "esd-header-title" }, "\u6570\u636E\u67E5\u770B", d.modeLabel !== "" ? /* @__PURE__ */ React3.createElement("span", { className: "esd-header-sub" }, d.modeLabel) : null), /* @__PURE__ */ React3.createElement(
    ...
    "\u5173\u95ED"
  )) : null, /* @__PURE__ */ React3.createElement("div", { className: "esd-dc-frame" }, /* @__PURE__ */ React3.createElement(
    "iframe",
    {
      ref: d.dcIframeRef,
...
function OverviewSection(props) {
  ...
  return /* @__PURE__ */ React3.createElement(Section, { icon: /* @__PURE__ */ React3.createElement(SecIcon, { name: "overview" }), title: "\u7ECF\u8425\u603B\u89C8", meta: `\u7545\u9500 ${overview.top_selling_sku || "--"}` }, /* @__PURE__ */ React3.createElement("div", { className: "esd-overview-body" }, /* @__PURE__ */ React3.createElement("div", { className: "esd-overview-line" }, /* @__PURE__ */ React3.createElement("span", { className: "esd-overview-label" }, "\u5F53\u524D\u7545\u9500 SKU"), /* @__PURE__ */ React3.createElement("span", { className: "esd-overview-value esd-overview-sku" }, overview.top_selling_sku || "--")), /* @__PURE__ */ React3.createElement("div", { className: "esd-overview-hint" }, "\u9500\u552E\u989D\u3001\u8BA2\u5355\u91CF\u3001\u5BA2\u5355\u4EF7\u3001\u9000\u6B3E\u7387\u3001\u8FD1 30 \u5929\u8D8B\u52BF\u3001\u7C7B\u76EE\u5360\u6BD4\u3001\u5E93\u5B58\u5065\u5EB7\u5EA6\u7B49\u8BE6\u7EC6\u6570\u636E\uFF0C\u8BF7\u67E5\u770B\u4E0B\u65B9\u7684\u300CBI \u6570\u636E\u770B\u677F\u300D\u3002")));
}
...
function CategorySection(props) {
  ...
  }), props.selected !== null && props.expanded ? /* @__PURE__ */ React3.createElement("div", { className: "esd-product-list" }, props.loading ? /* @__PURE__ */ React3.createElement("div", { className: "esd-loading" }, "\u52A0\u8F7D\u5546\u54C1\u2026") : null, !props.loading && props.products !== null && props.products.length === 0 ? /* @__PURE__ */ React3.createElement("div", { className: "esd-empty" }, "\u8BE5\u5206\u7C7B\u6682\u65E0\u5546\u54C1") : null, !props.loading && props.products !== null ? props.products.map((p) => /* @__PURE__ */ React3.createElement("div", { className: "esd-product", key: p.sku, title: `${p.sku} \uFF5C \u5E93\u5B58 ${p.stock}` }, /* @__PURE__ */ React3.createElement("span", { className: "esd-product-name" }, p.name), /* @__PURE__ */ React3.createElement("span", { className: "esd-chip " + (p.status === "on_sale" ? "esd-chip-on" : "esd-chip-off") }, p.status === "on_sale" ? "\u5728\u552E" : "\u4E0B\u67B6"), /* @__PURE__ */ React3.createElement("span", { className: "esd-product-stock" }, "\u5E93\u5B58 ", p.stock), /* @__PURE__ */ React3.createElement("span", { className: "esd-product-price" }, formatMoney(p.price)))) : null) : null, props.selected !== null && !props.expanded ? /* @__PURE__ */ React3.createElement("div", { className: "esd-cat", onClick: props.onToggle, title: "\u5C55\u5F00\u5546\u54C1\u5217\u8868" }, /* @__PURE__ */ React3.createElement("span", { className: "esd-todo-chevron" }, "\u25B8"), /* @__PURE__ */ React3.createElement("span", { className: "esd-todo-label" }, `\u5C55\u5F00 ${props.selected} \u5546\u54C1`)) : null);
}
function TopSection(props) {
  const rankClass = (i) => i === 0 ? " esd-rank-1" : i === 1 ? " esd-rank-2" : i === 2 ? " esd-rank-3" : "";
  return /* @__PURE__ */ React3.createElement(Section, { icon: /* @__PURE__ */ React3.createElement(SecIcon, { name: "top" }), title: "\u9500\u552E\u6392\u884C TOP5" }, props.snapshot.top.length === 0 ? /* @__PURE__ */ React3.createElement("div", { className: "esd-empty" }, "\u6682\u65E0\u9500\u552E\u6570\u636E") : null, props.snapshot.top.map((t, i) => /* @__PURE__ */ React3.createElement("div", { className: "esd-top-item", key: t.sku, title: `${t.sku}` }, /* @__PURE__ */ React3.createElement("span", { className: "esd-rank" + rankClass(i) }, i + 1), /* @__PURE__ */ React3.createElement("span", { className: "esd-top-name" }, t.name), /* @__PURE__ */ React3.createElement("span", { className: "esd-top-units" }, t.units, " \u4EF6"), /* @__PURE__ */ React3.createElement("span", { className: "esd-top-revenue" }, formatMoney(t.revenue)))));
}
function LowStockSection(props) {
  const { lowStock } = props.snapshot;
  return /* @__PURE__ */ React3.createElement(Section, { icon: /* @__PURE__ */ React3.createElement(SecIcon, { name: "lowstock" }), title: "\u4F4E\u5E93\u5B58\u9884\u8B66", meta: `\u9608\u503C \u2264 ${lowStock.length > 0 ? lowStock[0].threshold : 10}` }, /* @__PURE__ */ React3.createElement("div", { className: "esd-todo-row", onClick: props.onToggle, title: "\u70B9\u51FB\u5C55\u5F00/\u6536\u8D77\u6E05\u5355" }, /* @__PURE__ */ React3.createElement("span", { className: "esd-todo-icon" }, props.expanded ? "\u{1F4C2}" : "\u{1F4C1}"), /* @__PURE__ */ React3.createElement("span", { className: "esd-todo-label" }, "\u4F4E\u5E93\u5B58\u6E05\u5355\uFF08", lowStock.length, " \u4EF6\uFF09"), /* @__PURE__ */ React3.createElement("span", { className: "esd-todo-chevron" }, props.expanded ? "\u25BE" : "\u25B8")), props.expanded ? lowStock.length === 0 ? /* @__PURE__ */ React3.createElement("div", { className: "esd-empty" }, "\u5E93\u5B58\u5145\u8DB3\uFF0C\u6CA1\u6709\u4F4E\u4E8E\u9608\u503C\u5546\u54C1 \u{1F389}") : /* @__PURE__ */ React3.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 3, padding: "0 2px 4px" } }, lowStock.map((item) => /* @__PURE__ */ React3.createElement("div", { className: "esd-low-item", key: item.sku }, /* @__PURE__ */ React3.createElement("span", { className: "esd-low-name" }, item.name), /* @__PURE__ */ React3.createElement("span", { className: "esd-low-sku" }, item.sku), /* @__PURE__ */ React3.createElement("span", { className: "esd-low-cat" }, item.category), /* @__PURE__ */ React3.createElement("span", { className: "esd-low-stock" + (item.stock === 0 ? " esd-zero" : "") }, item.stock), /* @__PURE__ */ React3.createElement("span", { className: "esd-low-threshold" }, "/ \u2264", item.threshold)))) : null);
}
function ActionsSection(props) {
  const { actions } = props;
  const dock = actions?.dock;
  return /* @__PURE__ */ React3.createElement(Section, { icon: /* @__PURE__ */ React3.createElement(SecIcon, { name: "actions" }), title: "\u884C\u52A8\u6E05\u5355", meta: dock !== void 0 ? `${dock.open} \u9879\u5F85\u529E \xB7 \u4ECA\u5929\u5230\u671F ${dock.dueToday} \xB7 \u7D27\u6025 ${dock.urgent}` : void 0 }, /* @__PURE__ */ React3.createElement("div", { className: "esd-todo-row", onClick: props.onToggle, title: "\u70B9\u51FB\u5C55\u5F00/\u6536\u8D77\u884C\u52A8\u6E05\u5355" }, /* @__PURE__ */ React3.createElement("span", { className: "esd-todo-icon" }, props.expanded ? "\u{1F4C2}" : "\u{1F4C1}"), /* @__PURE__ */ React3.createElement("span", { className: "esd-todo-label" }, dock !== void 0 ? `\u5F85\u529E ${dock.open} \u9879 \xB7 \u4ECA\u5929\u5230\u671F ${dock.dueToday} \xB7 \u7D27\u6025 ${dock.urgent}` : "\u884C\u52A8\u6E05\u5355\u52A0\u8F7D\u4E2D\u2026"), /* @__PURE__ */ React3.createElement("span", { className: "esd-todo-chevron" }, props.expanded ? "\u25BE" : "\u25B8")), props.expanded ? actions === null || actions.actions.length === 0 ? /* @__PURE__ */ React3.createElement("div", { className: "esd-empty" }, "\u6682\u65E0\u5F85\u529E\u4E8B\u9879 \u{1F389}") : /* @__PURE__ */ React3.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 3, padding: "0 2px 4px" } }, actions.actions.map((a) => /* @__PURE__ */ React3.createElement("div", { className: "esd-low-item" + (a.urgent ? " esd-zero" : ""), key: a.id }, /* @__PURE__ */ React3.createElement("span", { className: "esd-low-name" }, a.kind === "overdue" ? "\u23F0" : a.kind === "ship" ? "\u{1F4E6}" : "\u26A0\uFE0F", " ", a.title, a.dueToday === true ? /* @__PURE__ */ React3.createElement("span", { style: { color: "#e5484d", fontWeight: 600 } }, "\uFF08\u4ECA\u5929\u5230\u671F\uFF09") : null), /* @__PURE__ */ React3.createElement("span", { className: "esd-low-sku" }, a.detail)))) : null);
}
...
/* \u2500\u2500 \u9762\u677F\u5BB9\u5668\uFF08fixed \u53F3\u4FA7\uFF0C\u53E0\u52A0\u5F0F\uFF0C\u4E0D\u5360\u5B98\u65B9 sidebar\uFF09 \u2500\u2500
   \u9ED8\u8BA4\u975E\u5168\u5C4F\uFF1A\u6570\u636E\u5C55\u793A\u9762\u79EF \u2248 \u5168\u5C4F\u9762\u677F\u7684 35%\uFF0835vw \u5BBD \xD7 \u6EE1\u9AD8\uFF09\u3002
